...
"""
import bot # This line is not strictly necessay as variables and imports are shared across files in the ESP32, however, if you are using VSC, this will be helpful for viewing doctrings.
